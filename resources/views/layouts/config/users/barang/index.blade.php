                ...
                <div class="card">
                    ...
                    <div class="mb-3">
                        <a href="{{ route('barang.create') }}" class="btn btn-primary btn-lg">
                            <i class="icon icon-cog3"></i> Input Data Barang
                        </a>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-toggle="modal" data-target="#modalhapus{{ $d->id }}"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Apakah Anda yakin ingin menghapus data Barang <b
                                                        class="text-warning">{{ $d->nama_barang }} ini?</b>
                                                    <b></b>
                                                </div>
